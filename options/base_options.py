...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--names_file', type=str, default=None, help='Path to a file that contains file names of images which must '
                                                                              'be included in the train set')
        # for displays
